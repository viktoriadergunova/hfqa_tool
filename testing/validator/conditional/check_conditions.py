...
INPUT_XLSX = "testing/conditional_test.xlsx"
SCHEMA_PATH = "hf_schema.yaml"
COND_RULES_PATH = "conditional_rules.yaml"
...
def main():
    ...
    df_raw = excel_to_parquet(
        ...
        parquet_path="testing/conditional_test.raw.parquet",
        sheet_name=0,
        meta_rows=0,  # keine Meta-Zeilen in dieser Testdatei
    )

    # Optional: row_type absichern
